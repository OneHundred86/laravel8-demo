...
- 属性值有 expires、path、domain、samesite、httponly、secure等；
  ...
  - samesite:
    ...
    | -------- | ------------------------------------ | ---------------------------------------- | -------------------------------------- | -------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- | -------- |
    | `Strict` | Request`能携带`<br>Response`能修改`  | Request`不能携带`<br/>Response`能修改`   | Request`不能携带`<br/>Response`能修改` | Request`不能携带`<br/>Response`不能修改`                                   | 登录、支付等敏感操作                                                                                                                  | 最高     |
    | `Lax`    | Request`能携带`<br/>Response`能修改` | Request`能携带`<br/>Response`能修改`     | Request`不能携带`<br/>Response`能修改` | Request`不能携带`<br/>Response`不能修改`                                   | 大多数普通场景（默认推荐）                                                                                                            | 中       |
    | `None`   | Request`能携带`<br/>Response`能修改` | Request`能携带`<br/>Response`能修改`     | Request`能携带`<br/>Response`能修改`   | Request`能携带`<br/>Response`能修改`<br>（需使用https请求，且secure=true） | **跨域共享 Cookie**（需使用https请求）<br>注意：所在页面可以不是https，且页面域名和请求域名可以毫无关系，即可以不是父子或者兄弟域名） | 最低     |
